            ...
            <ul class="nav flex-column flex-grow-1">
                ...
                <li class="nav-item">
                    <a href="{{ route('pembina.organisasi') }}"
                        ...
                        <i class="fas fa-building"></i> Data Organisasi
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="{{ route('pembina.validasi') }}"
                        ...
                        <i class="fas fa-check-circle"></i> Validasi Kegiatan
                    </a>
                </li>
                <li class="nav-item">
            ...
            <div class="topbar d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="topbar-left">
                        ...
                        <p class="d-none d-sm-block">Selamat datang kembali,
                ...
                <div class="d-flex align-items-center gap-2 gap-md-3">
                    ...
                    <!-- Profil -->
                    <a href="{{ route('pembina.profil') }}" class="profile-link" title="Buka profil">
                        ...
                        <div class="text-start profile-text profile-name-text">
                            <div class="fw-semibold" style="font-size:0.9rem;">{{ $user?->name ?? 'Tamu' }}</div>
